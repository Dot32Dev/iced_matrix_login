...
// This is not my creation, see the iced demo this is from here:
    ...
    Theme: StyleSheet,
{
    ...
    /// duration that a full rotation would take if the cycle rotation were set
    /// to 0.0 (no expanding or contracting)
